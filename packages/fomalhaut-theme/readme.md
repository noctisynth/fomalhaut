...
During `bun run dev`, a development-only transport simulates one user and a PAM
prompt in an ordinary browser. Use `fomalhaut` as the fixture password. Production
builds never fall back to the simulated transport.
